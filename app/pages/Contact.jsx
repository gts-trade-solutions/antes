      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-3xl font-bold text-nrs-navy mb-6">Send us a Message</h2>
              <p className="text-nrs-dark-gray mb-8 leading-relaxed">
                Fill out the form below and we'll get back to you as soon as possible to discuss your industrial
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-nrs-navy mb-2">First Name *</label>
                    <Input type="text" required className="w-full" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-nrs-navy mb-2">Last Name *</label>
                    <Input type="text" required className="w-full" />
                  </div>
                </div>

                <div>
                  <label className="block text-sm font-medium text-nrs-navy mb-2">Email Address *</label>
                  <Input type="email" required className="w-full" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-nrs-navy mb-2">Phone Number</label>
                  <Input type="tel" className="w-full" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-nrs-navy mb-2">Company Name</label>
                  <Input type="text" className="w-full" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-nrs-navy mb-2">Service Required</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-nrs-navy mb-2">Message *</label>
                  <Textarea
                    required
            ...
            {/* Contact Information */}
            <div>
              <h2 className="text-3xl font-bold text-nrs-navy mb-6">Get in Touch</h2>
              <p className="text-nrs-dark-gray mb-8 leading-relaxed">
                Reach out to us directly through any of the channels below. Our team is ready to assist you with your
              ...
              <div className="space-y-6">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-nrs-dark-gray">+91 87142 81444</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-nrs-dark-gray">info@antesglobal.com</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-nrs-dark-gray leading-relaxed mt-2">
                          ...
                          <br />
                          Shouk Al Kabeer Complex, Fahad Al Salem Street Al Qibla, Block 11,
                          <br />
                          Kuwait City
                        </p>

                        <div className="mt-4 space-y-2">
                          <div className="flex items-center gap-2 text-nrs-dark-gray">
                            <Mail className="w-4 h-4 text-nrs-blue" />
                            <span>info@antesglobal.com</span>
                          </div>
                          <div className="flex items-center gap-2 text-nrs-dark-gray">
                            <Phone className="w-4 h-4 text-nrs-blue" />
                            <span>+974 3000 6550</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <Card className="hover-lift card-shadow">
                  <CardContent className="p-6">{/* Business Hours (optional) */}</CardContent>
                </Card>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-nrs-dark-gray leading-relaxed">
                          Antes Process Systems Sdn Bhd
                          <br />
                          Industrial Cooling Specialists
                          <br />
