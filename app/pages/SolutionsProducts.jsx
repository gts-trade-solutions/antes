  ...
  const solutions = [
    {
      ...
      description:
        "Since 1986, NRS offers a extensive menu of customized industrial cooling or freezing solutions to meet your budget or exacting needs. Our Centralized Refrigeration Systems include dedicated control packages that orchestrate your cooling needs from a central location with a variety of natural and low-GWP refrigerants.",
    ...
    },
    {
      ...
      description:
        "From landfill, well-head and flue gas recovery, our Industrial Gas Compression Packages make it simple, cost effective way to operate natural gas applications. Our systems are designed for reliability and efficiency in various industrial environments.",
    ...
    },
    {
      ...
      description:
        "Our Fluid Chillers for Manufacturing Plants & Industrial Facilities Package can be designed to cool a variety of fluids such as water, glycols, ethanol or methanol. Perfect for precision cooling requirements in manufacturing processes.",
      image: fluidChillers,
      features: [
      ...
      <section className="py-16 bg-nrs-navy text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto leading-relaxed">
            Comprehensive industrial cooling solutions designed to meet your
            ...
            {solutions.map((solution, index) => (
              ...
              >
                <div className={`${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
                  ...
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold text-nrs-navy mb-4">
                      Key Features:
                    </h3>
                    <ul className="space-y-2">
                      {solution.features.map((feature, featureIndex) => (
                        <li
                          key={featureIndex}
                          className="flex items-center text-nrs-dark-gray"
                        >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-nrs-dark-gray leading-relaxed max-w-3xl mx-auto">
              Complete support services to ensure optimal performance of your
              cooling systems.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="hover-lift card-shadow bg-white">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-nrs-dark-gray leading-relaxed">
                  Professional installation ensuring optimal performance and
                  safety compliance.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover-lift card-shadow bg-white">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-nrs-dark-gray leading-relaxed">
                  Tailored engineering solutions to meet your specific
